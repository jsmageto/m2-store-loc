...
class Edit extends \JM\StoreLocator\Controller\Adminhtml\StoreLocator
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('jm_storelocator_storelocator', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Storelocator'));
        return $resultPage;
    }
}
